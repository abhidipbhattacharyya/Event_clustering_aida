...
class My_Model:
    def __init__(self,input_shape, dimention):
        ...
        self.prediction = Dense(1, activation='sigmoid')(Dense(30,activation='relu')(Dense(250, activation='relu')(self.merged_layer)))
    ...
    def save_model(self, path):
        model_file = os.path.join(path,'model3_mse'+str(self.epch)+'.h5')
